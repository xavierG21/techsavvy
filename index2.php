...
<div class="banner" style="background-color:#000000">    	   
    <img src="images/ISP.jpg"  class="img-responsive" alt="slide" style="height: 600px;">
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown" style="color: #bfa145; font-weight: bolder;">Internet Service Provider</h1>
                <p class="animated fadeInUp" style="color: #bfa145; font-size: 30px;">Extraordinary service for extraordinary customers.</p>                
            </div>
